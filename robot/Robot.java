...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    // SmartDashboard.putBoolean("Turn45:  ", oi.isTurn45());
		// SmartDashboard.putBoolean("Turn90:  ", oi.isTurn90());
		// SmartDashboard.putBoolean("Turn180:  ", oi.isTurn180());
		// SmartDashboard.putBoolean("Cargo1:  ", oi.isCargo1());
		// SmartDashboard.putBoolean("Cargo2:  ", oi.isCargo2());
		// SmartDashboard.putBoolean("Cargo3:  ", oi.isCargo3());
		// SmartDashboard.putBoolean("Panel1:  ", oi.isPanel1());
		// SmartDashboard.putBoolean("Panel2:  ", oi.isPanel2());
		// SmartDashboard.putBoolean("Panel3:  ", oi.isPanel3());
		// SmartDashboard.putBoolean("Floor:  ", oi.isFloor());
		// SmartDashboard.putBoolean("PanelOut:  ", oi.isPanelOut());
		// SmartDashboard.putBoolean("PanelIn:  ", oi.isPanelIn());
		// SmartDashboard.putBoolean("CargoIn:  ", oi.isCargoIn());
		// SmartDashboard.putBoolean("CargOut:  ", oi.isCargoOut());
		// SmartDashboard.putBoolean("Punch:  ", oi.isPunch());
  }
